---
title: "API Base URLs"
description: "REST and WebSocket endpoints for accessing real-time wearable data"
---
> ## 📘API Base URLs
> 
...
![Data flow in a real time streaming connection](https://files.readme.io/51e8eaf-image.png)
